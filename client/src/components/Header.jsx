...
const Header = () => {
  ...
  return (
    ...
    viewport={{once:true}}
    >
        <motion.div className='flex flex-row text-stone-500 inline-flextext text-center bg-white gap-2
        ...
        >
            {Array(6).fill('').map((item,index)=>(
                ...
                src={index % 2 === 0 ? assets.sample_img_1 : assets.sample_img_2} alt="" 
                key ={index} width={70}/>
            ))}
        </motion.div>
        ...
        >Generate images from ink2Image</motion.p>
    </motion.div>
  )
}
